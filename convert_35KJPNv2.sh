...
# AF
echo "create tommo-3.5kjpnv2-20180625-af_snvall.MAF.genericdb using autosome.vcf, chrX_PAR3.vcf and chrMT.vcf"
foreach vcf in data/tommo-3.5kjpnv2-20180625-af_snvall-{autosome,chrX_PAR3,chrMT}.vcf
...
echo "create tommo-3.5kjpnv2-20180625-af_snvall.INFO.genericdb using autosome.vcf, chrX_PAR3.vcf and chrMT.vcf"
...
foreach vcf in data/{tommo-3.5kjpnv2-20180625-af_snvall-chrX_PAR3.vcf,tommo-3.5kjpnv2-20180625-af_snvall-chrMT.vcf}
